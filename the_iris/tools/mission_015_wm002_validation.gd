...
## WM_002 The Forgotten Museum validation harness.
## Headless usage:
##   godot --headless --path the_iris --script res://tools/mission_015_wm002_validation.gd

func _initialize() -> void:
	for _i: int in range(5):
		await process_frame
	var checks_script: GDScript = load("res://tools/mission_015_wm002_validation_checks.gd")
